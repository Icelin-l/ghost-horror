...
const questions = [
    ...
    {q:"多国势力纷争，你向往的秩序？",opt:["强者划分高低秩序","各国互不干涉安稳生活","各族平等消解歧视隔阂"]},
    ...
    {q:"队友失误导致任务崩盘？",opt:["心生疏远刻意避开对方","复盘共同补救失误","主动揽责保护队友不受责罚"]},
...
function handleAnswerSubmit(){
    ...
    if(val.includes("博士")) alert("你仍在逃避");
    else if(val.includes("预言家")) openOraclePage();
    else alert("PRTS无响应");
}
